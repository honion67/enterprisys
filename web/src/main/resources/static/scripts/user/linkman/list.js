    ...
    var tableIns = table.render({
        ...
        cols: [[
            {type: "checkbox", fixed: "left", width: 50},
                    ...
                    {field: 'officeStatus', title: '任职状态', minWidth: 100, align: "center",templet:
                            function (d){
                                if(d.officeStatus==0){
                                    return "<button type=\"button\" class=\"layui-btn layui-btn-normal layui-btn-radius\">在职</button>"
                                }else if(d.officeStatus==1){
                                    return "<button type=\"button\" class=\"layui-btn layui-btn-warm layui-btn-radius\">离职</button>"
                                }else{
                                    return "未知状态"
                                }
                            }
